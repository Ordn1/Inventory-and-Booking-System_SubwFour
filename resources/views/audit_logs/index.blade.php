...
@section('title','Audit Logs - SubWFour')
...
@section('content')
<h2 class="text-accent">AUDIT LOGS</h2>
...
<div class="glass-card glass-card-wide">
    <form id="auditLogsFilterForm" method="GET"
    ...
    <div style="display:flex;gap:10px;margin-bottom:10px;">
        <button class="btn btn-primary"
                ...
                onclick="document.getElementById('auditLogsFilterForm').submit(); return false;">
            Apply
        </button>
